        ...
        <Carousel.Item>
          <div className="d-flex carousel justify-content-md-between align-items-md-center">
            <img
              ...
              alt="First slide"
            />
            <p className="text-monospace"><blockquote>Woof Woof! Tasty dog food indeed!</blockquote>-Burt</p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          <div className="d-flex carousel justify-content-md-between align-items-md-center">
            <img
              ...
              alt="Second slide"
            />
            <p className="text-monospace"><blockquote>Tails & Whiskers is the best dog and cat food company in whole of UK! Couldnt recommend it more </blockquote>-Sarah Jay</p>
          </div>
        </Carousel.Item>
        <Carousel.Item>
          <div className="d-flex carousel justify-content-md-between align-items-md-center">
            <img
              ...
              alt="Third slide"
            />
            <p className="text-monospace"><blockquote>Great customer service and my kat loves the Cosmic Catnip!</blockquote>-AJ</p>
          </div>
        </Carousel.Item>
      </Carousel>
    </>
